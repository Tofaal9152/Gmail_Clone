...
const Sidebar = () => {
  ...
  return (
    <div className="bg-[#F6F8FC] w-[17%] h-screen">
      {/* //first_Compass */}
      <div className="flex mx-2 justify-center items-center cursor-pointer space-x-2 bg-[#C2E7FF] w-[9rem] h-[3.7rem] duration-300 rounded-3xl hover:shadow-md">
      ...
      <div className="flex items-start justify-between mt-[3rem] px-[6%]">
        <span className="font-md text-gray-600 font-medium text-xl">Labels</span>
